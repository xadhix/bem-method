...
К [реализации](../definitions/definitions.ru.md#) блока могут относится, например, картинки, тесты, документация, примеры использования. Каждая технология находится в отдельном файле и хранится в директории блока.
...
Разделение JavaScript-реализации на отдельные файлы помогает сохранять независимость блоков, упрощает отладку и повторное использование кода.
