...
Смешать реализации двух разных блоков без копирования кода можно при помощи микса. То есть смешать на одном DOM-узле блок `nav` и элемент `articles__nav`.
...
>Точно также миксовать можно не только блоки с элементами, но и другие БЭМ-сущности.
