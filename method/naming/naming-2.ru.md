...
Приведенные в данном разделе примеры основаны на каноническом стиле именования, описанном ниже. Однако он не исключает наличия [альтернативных схем](#name-scheme).
