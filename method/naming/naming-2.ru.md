...
Методология оперирует понятиями блока, эелемента и модификатора и данная статья рассказыает о том, как мы договорились их именовать. правилах именования (сделать блоки ссылками на дефинитионс и убрать)

Методология БЭМ задает на ряд соглашений и правил по именованию css-селекторов(), соблюдение которых решает многие насущные для веб-разработчика проблемы:
...
* [Как избежать взаимного влияния компонентов друг на друга?](#)
