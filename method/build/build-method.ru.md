...
* [Зависимости](#Поиск-зависимостей) — определяют дополнительные БЭМ-сущности, необходимые для создания страницы.
...
Существуют различные [способы построения декларации](../decl/declaration.ru.md).
